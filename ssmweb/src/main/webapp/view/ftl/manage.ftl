    ...
    <div class="col-md-10" id="data-table">
        ...
        <div class="row table-content">
            ...
            <div class="col-md-10 data-table-content">
                <#if Session["datamall_usage"] != 2>
                    <div class="list-inline-dt">
                        <a id="demandExchange" href="${rootRoute}/manage/photo">图片管理</a>
                    <#--<#if usage == 0 || 1>-->
                        <span class="sep">|</span>
                        <a id="supplyExchange" href="${rootRoute}/manage/video">视频管理</a>
                        <span class="sep">|</span>
                        <a id="supplyExchange" href="${rootRoute}/manage/other">已同步记录</a>
                    </div>
                </#if>
                ...
                <form class="form-horizontal" id="formExport" name="formExport">
                    <div class="form-group">
                        ...
                        <div class="col-lg-3" style="padding-left: 0px">
                            ...
                            <input id="exportInput" type="button" class="btn btn-primary pull-right" value="导出"style="margin-right: 5px;" type="submit" onclick="exportDiretory()"/>
                            <button id="btn-import" type="button" class="btn btn-primary pull-right" style="margin-right: 5px;">导入</button>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <#--表格部分-->
                <table class="table data-table tableBorderBottom" id="listTable"style="margin-top: -15px;" >
                    ...
                    <tr class="data-table-content-head">
                        ...
                        <th class="text-center" style="width:14%;">关键词</th>
                        <th class="text-center" style="width:14%;">作者</th>
                        <th class="text-center" style="width:15%;">创建日期</th>
                        <th class="text-center" style="width:8%;">大小</th>
                    ...
                    <#--<#assign var = 0 >-->
                        ...
                        <#--可通过参数传参，也可通过data-id=${dbaccess.id}，js调用this.data("id")获取到该条索引的id -->
                            ...
                            <td class="text-left">
                                <a href="../directory/datadirectory/directoryDetail/${data.id}">${data.directoryNo}</a>
                            </td>
...
<script src="${rootRoute}/view/js/plat-admin-datacatalog.js"></script>
